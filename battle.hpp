...
struct Battle_Config
{
	...
	int pvp_short_damage_rate;
	int pvp_long_damage_rate;
	int pvp_weapon_damage_rate;
	int pvp_magic_damage_rate;
	int pvp_misc_damage_rate;
	int pvp_flee_penalty;
...
// eAthena additions
	...
	int hpratesavage;
	int hplimitsavage;
	int hprateextremebio;
	int hplimitextremebio;
	int hpratehard;
	int hplimithard;
	int dano_magico;
	int aumento_drop;
	...
	int hprateextremecheff;
	int hplimitextremecheff;
	int dano_extremecheff;
	...
	int desativarchecar;
	int dropextreme;
	int desativarexcelencia;
	int desativarchannel;
	int scripttimer;
	int multiserver;
	int blackfriday;
	int carnaval;
	...
	int stopdano;
	int stopmobskill;
	int exp_rate_adicional;
	int exp_rate_relogio;
	
	int capsula; // 40063
	int ticket_avancado; // 40064
	int flogo_glacial; // 283471
	int energia_congelada; // 283472
	int essencia_primordial; // 50145
	int cristal_bio_sav; // 38073
	int moeda_cheff_sav; // 38077
	int nucleo_pes; // 50330
	int runa_corrompida; // 1001312
	int moeda_evento; // 40080
	int carta_amantes; // 51151
	int perga_campeoes; // 51152
	
	int cupom_visuais; // 48889
	int fragmento_elemental; // 11163
	int refinadora_complexa; // 33360
	int espirito_nebula; // 44450
	int grade_armadura; // 44499
	int hero; // 29509
	int release_of_magic; // 29371
	int fury; // 312475
	int epifania; // 47777
	int dynast; // 29436
	int arcana; // 29585
	int palito_baunilha; // 14618
	int palito_cassis; // 14619
	int palito_chocolate; // 14617
	int palito_laranja; // 14616
	int palito_limao; // 14620
	int palito_morango; // 14621
	
	int super_mega_elunium; // 70002
	int minerio_ultimate; // 70152
	int mini_refinadora; // 33362
	int grade_escudo; // 44582
	int runa_corrom_sup; // 283501
	int runa_corrom_new; // 10013120
	int runa_corrom_sup_new; // 2835010
	int fragmento_kafra; // 290444
	int niver_maestria; // 44731
