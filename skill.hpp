...
#define MAX_SKILL_PRODUCE_DB	308 /// Max Produce DB
...
enum e_skill {
	...
	DM_CANCELAR_MAGIA = 802,
	DM_CORTAR_VINHAS = 803,
	DM_FURTO = 804,
	DM_FORJA_DESPERTAR = 805,
	AN_FISICO = 806,
	AN_MAGICO = 807,
	AN_DISTANCIA = 808,
	GPV_MEDICAR_BLUE = 809,
	GPV_MEDICAR_GREEN = 810,
	GPV_MEDICAR_RED = 811,
	NEW_SHARPSHOOT = 812,
	RB_MAESTRIA_ROPS = 813,
	RB_MAESTRIA_PK = 814,
	MR_SAMURAI = 815,
	NPC_INVULNERA = 816,
	NPC_ENFRAQUECER = 817,
	NPC_ENRAIZAR = 818,
	NPC_AGULHA_VENENOSA = 819,
	NPC_ENFRAQUECER_HER = 820,
	RB_MAESTRIA_BR = 821,
	HY_MAESTRIADUASMAOS = 822,
	HL_MAESTRIA = 823,
	DM_JOKENPO_PEDRA = 824,
	DM_JOKENPO_PAPEL = 825,
	DM_JOKENPO_TESOURA = 826,
	NPC_JOKENPO_PEDRA = 827,
	NPC_JOKENPO_PAPEL = 828,
	NPC_JOKENPO_TESOURA = 829,
	NT_GRAVITYCONTROL = 830,
	RB_CHARGE = 831,
	MR_BENCAO_HEROI = 832,
	DM_PARRY = 833,
	RK_RUNASELEMENTAIS = 834,
	REBORN_CHARGE = 835,
	HR_CACA_TESOURO = 836,
	SH_HYUN_ROKS_BREEZE_ANIMA = 837,
	SH_HYUN_ROK_CANNON_ANIMA = 838,
	SU_SV_STEMSPEAR_ANIMA = 839,
	SU_PICKYPECK_ANIMA = 840,
	RB_MAESTRIA_ANIVERSARIO = 841,
	IQ_THIRD_PUNISH = 842,
	IQ_THIRD_CONSECRATION = 843,
